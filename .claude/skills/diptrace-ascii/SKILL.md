...
Keep this adapter thin. Claude-specific trigger wording belongs here; durable format knowledge, audit rules, scripts, and reusable lessons belong in the shared base.
