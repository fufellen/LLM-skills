...
8. **Раскрывай сжатые формулировки через наблюдаемый или рассчитанный
   ...
   «направление фазовой перестройки». Пиши, что именно показывает расчёт:
   «модели по-разному определяют, у какого материала меньше длина фазового
   сдвига», «знак изменения действительной части эффективного показателя
